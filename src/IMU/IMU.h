...
namespace IMU
{
    ...
    void MadgwickAHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz, uint32_t now);
...
// mpu9250 registers
#define MPUREG_SELF_TEST_GX     0x00 //
#define MPUREG_SELF_TEST_GY     0x01 //
#define MPUREG_SELF_TEST_GZ     0x02 //
