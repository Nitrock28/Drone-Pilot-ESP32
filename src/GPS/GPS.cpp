...
namespace GPS{
    ...
    void init(HardwareSerial* gpsBus){
        _ser = gpsBus;
        TargetIndex=0;
        TotalTargets=1;
        ...
        _ser->print("$PUBX,40,GBS,0,0,0,0,0,0*4D\r\n");
        _ser->print("$PUBX,40,VTG,0,0,0,0,0,0*5E\r\n");
        _ser->print("$PUBX,40,GLL,0,0,0,0,0,0*5C\r\n");
        _ser->print("$PUBX,40,GSA,0,0,0,0,0,0*4E\r\n");
        _ser->print("$PUBX,40,GSV,0,0,0,0,0,0*59\r\n");
        _ser->print("$PUBX,40,GGA,0,0,0,0,0,0*5A\r\n");
        _ser->print("$PUBX,40,RMC,0,0,0,0,0,0*47\r\n");
